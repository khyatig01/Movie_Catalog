...
public class Movie implements Comparable<Movie> {
	 ...
	 * @throws an IllegalArgumentException if year is less than 1900, if rating is
	 *            out of the range from 0.0 to 10.0 or if name is null or an empty
	 *            string
	 */
	...
	/**
	 * Compares two movies for ordering with respect to their ratings, years, and
	 * names
	 * 
	 * @return 0 if otherMovie has the same year, same rate, and same name as this
	 *         movie; an integer less then 0 if this movie is older than the
	 *         otherMovie, or if they were produced in the same year but this movie
	 *         has a lower rating, or if they have the same year and same rating but
	 *         this movie has a lower lexical order than otherMovie; otherwise
	 ...
	 * 
	 * @param obj other object to compare @ return true if this movie is equal to
	 *            the input argument obj and false otherwise
	 */
	@Override
